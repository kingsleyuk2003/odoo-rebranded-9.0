    ...
    def _handle_exception(self, exception):
        ...
        try:
            ...
            if isinstance(exception, AuthenticationError):
                error['code'] = 100
                error['message'] = "System Session Invalid"
            if isinstance(exception, SessionExpiredException):
                error['code'] = 100
                error['message'] = "System Session Expired"
...
System URLs are CSRF-protected by default (when accessed with unsafe
HTTP methods). See
https://www.odoo.com/documentation/9.0/reference/http.html#csrf for
more details.

* if this endpoint is accessed through System via py-QWeb form, embed a CSRF
